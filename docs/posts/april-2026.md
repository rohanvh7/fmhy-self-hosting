...
description: April 2026 updates
date: 2026-04-01
next: false
...
- Moved OuterTune from YouTube Music Players to Android Audio Player as they're [dropping YTM support](https://github.com/OuterTune/OuterTune/discussions/1116).
...
- Starred [Khoj + Google Flow](https://fmhy.net/ai#image-generation) in Image Gen, both give unlimited Nano Banana Pro + Imagen 4.
...
- Starred two [FreshRSS](https://fmhy.net/internet-tools#rss-readers) instances in RSS Reader (rss.fmhy + Prodottoinrete), its customizable, web-based, and allows unlimited feeds.
